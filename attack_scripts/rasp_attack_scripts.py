...
print("Which RASP do you want to test?\nEnter 'sqreen' or 'contrast_security':")
RASP_NAME = raw_input()
...
sqreen_url = 'http://34.213.200.47:3000'
contrast_url = 'http://54.85.15.24:80'
sqreen_product_url = 'http://34.213.200.47:3000/rest/product/search'
contrast_product_url = 'http://54.85.15.24:80/rest/product/search'
...
if RASP_NAME == "sqreen" :
    #url
    jsurl = sqreen_url
    product_url = sqreen_product_url
    #read log syntax
    '''rd_log = mod_rd_log
    ...
    file_traversal_list = mod_rfi_regex
    sqli_leakage_list = mod_sql_leakage_regex
    #log removal syntax
    rm_log = mod_rm_log
    #restart nginx
...
if RASP_NAME == "contrast_security" :
    jsurl = contrast_url
    product_url = contrast_product_ur
    valid = 1
    #sys.exit()

if valid == 0:
    print("Invalid RASP name")
    sys.exit()
